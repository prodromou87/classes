...
To complete the final download [this file as plain text](final.lhs) and
answer each question, filling in code where noted.
Your code **must** typecheck, or you get 0. 
Feel free to add your own tests to this file 
to exercise the functions you write. Submit by sending 
this file, filled in appropriately, to `cse230@goto.ucsd.edu` 
with the subject "FINAL". You will receive a confirmation 
email after submitting. Please note that this address 
is unmonitored; if you have any questions about the 
