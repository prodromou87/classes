...
./mmpy_conflicts_double_16 -n 256 -r 20
./mmpy_conflicts_double_16 -n 512 -r 10
./mmpy_conflicts_double_16 -n 1024 -r 5
./mmpy_conflicts_double_16 -n 2048 -r 1

./mmpy_conflicts_double_32 -n 256 -r 20
./mmpy_conflicts_double_32 -n 512 -r 10
./mmpy_conflicts_double_32 -n 1024 -r 5
./mmpy_conflicts_double_32 -n 2048 -r 1

./mmpy_conflicts_single_16 -n 256 -r 20
./mmpy_conflicts_single_16 -n 512 -r 10
./mmpy_conflicts_single_16 -n 1024 -r 5
./mmpy_conflicts_single_16 -n 2048 -r 1

./mmpy_conflicts_single_32 -n 256 -r 20
./mmpy_conflicts_single_32 -n 512 -r 10
./mmpy_conflicts_single_32 -n 1024 -r 5
./mmpy_conflicts_single_32 -n 2048 -r 1
