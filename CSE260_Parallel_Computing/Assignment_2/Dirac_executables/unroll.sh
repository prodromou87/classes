...
./mmpy_unroll_double -n 256 -r 20
./mmpy_unroll_double -n 512 -r 10
./mmpy_unroll_double -n 1024 -r 5
./mmpy_unroll_double -n 2048 -r 1

./mmpy_unroll_single -n 256 -r 20
./mmpy_unroll_single -n 512 -r 10
./mmpy_unroll_single -n 1024 -r 5
./mmpy_unroll_single -n 2048 -r 1
